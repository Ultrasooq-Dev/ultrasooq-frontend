  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        ref={dialogRef}
      >
        <div className="flex items-center justify-between border-b border-border px-6 py-4" dir={langDir}>
        ...
        <div className="px-6 py-6">
          <p className="mb-6 text-center text-muted-foreground" dir={langDir} translate="no">
