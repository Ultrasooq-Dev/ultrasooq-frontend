    ...
    <div className="w-full">
      <Tabs onValueChange={(e) => setActiveTab(e)} value={activeTab}>
          ...
          <div className="min-h-[400px] p-8 sm:p-10 lg:p-12">
            <div className="space-y-4">
              ...
              <ReviewSection
                ...
                isCreator={meDataId === productDetails?.adminId}
              />
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="qanda" className="mt-0">
          <div className="min-h-[400px] p-8 sm:p-10 lg:p-12">
            <QuestionsAnswersSection hasAccessToken={haveAccessToken} productId={searchParamsId} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="services" className="mt-0">
          <div className="min-h-[400px] p-8 sm:p-10 lg:p-12">
            <div className="space-y-4">
              ...
              <RelatedServices
                productId={Number(searchParamsId) || 0}
                ...
                productCartId={
                  memoizedCartList.find((item: any) => item.productId == Number(searchParamsId))?.id
                }
                isChildCart={
                  !!memoizedCartList
                    ...
                    ?.find((c: any) =>
                      !!c.cartProductServices.find(
                        (r: any) => r.relatedCartType == "PRODUCT" && r.productId == searchParamsId,
                      ),
                    )
                }
              />
