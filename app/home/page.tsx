  ...
  return (
    <>
      ...
      <HomeCategorySection
        ...
        haveAccessToken={haveAccessToken}
        onWishlist={handleAddToWishlist}
        navConfig={{ categoryId: 464, categoryIds: "464,468,472", colorClass: "bg-info/5" }}
        sectionClass="bg-card"
      />
      ...
      <HomeCategorySection
        ...
        haveAccessToken={haveAccessToken}
        onWishlist={handleAddToWishlist}
        navConfig={{ categoryId: 496, categoryIds: "496,513", colorClass: "bg-success/5" }}
        sectionClass="bg-muted/40"
      />
      ...
      <HomeCategorySection
        ...
        haveAccessToken={haveAccessToken}
        onWishlist={handleAddToWishlist}
        navConfig={{ categoryId: 477, categoryIds: "477,482,488,499", colorClass: "bg-warning/5" }}
        sectionClass="bg-card"
      />
