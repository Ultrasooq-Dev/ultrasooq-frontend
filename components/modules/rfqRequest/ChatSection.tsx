      ...
      <div className="d-flex w-full">
        <div className="mt-5 flex w-full flex-wrap items-end">
          ...
          <div className="w-[calc(100%-2rem)] pl-2">
            <div className="mb-1 w-full rounded-xl bg-muted p-3 text-sm">
              <p>
        ...
        <div className="mt-5 flex w-full flex-wrap items-end">
          <div className="w-[calc(100%-2rem)] pr-2 text-right">
            <div className="mb-1 inline-block w-auto rounded-xl bg-blue-600 dark:bg-blue-500 p-3 text-right text-sm text-white">
              <p>
