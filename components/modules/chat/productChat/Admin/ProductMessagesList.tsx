...
const ProductMessageItem: React.FC<ProductMessageItemProps> = ({ item, onSelect, isSelected = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* Arrow Indicator */}
      <div className="flex shrink-0 items-center">
        <svg className="h-5 w-5 text-muted-foreground transition-all duration-200 group-hover:text-dark-orange group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
